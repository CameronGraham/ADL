        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<EngineerRequest>().HasData(
                new EngineerRequest()
                {
                    ...
                    Town = "TownName",
                    Postcode = "postcode",
                    AppointmentDate = DateTime.Parse("18/05/2022 00:00:00"),
                ...
                new EngineerRequest()
                {
                    ...
                    Town = "TownName",
                    Postcode = "postcode",
                    AppointmentDate = DateTime.Parse("19/05/2022 00:00:00"),
                    ...
                    new EngineerRequest()
                    {
                        ...
                        Town = "TownName",
                        Postcode = "postcode",
                        AppointmentDate = DateTime.Parse("21/05/2022 00:00:00"),
                        AppointmentTime = "09:00 - 11:00",
                        VehicleRegistation = "1234567",
                        JobCategory = "breakdown",
                        Comments = "The bus is broken"
